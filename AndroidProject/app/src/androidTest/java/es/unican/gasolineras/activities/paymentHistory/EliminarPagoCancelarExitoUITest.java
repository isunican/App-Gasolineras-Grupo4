...
@HiltAndroidTest
public class EliminarPagoCancelarExitoUITest {
     ...
     */
    @Test
    public void EliminarPagoCancelarExitoTest() {
        // Insert of payments
        // First payment
        p1 = new Pago();
        ...
        // Cancel the deletion of second payment
        ...
        pago2.onChildView(withId(R.id.Cantidad)).check(matches(withText("Cantidad: \n23.0")));
