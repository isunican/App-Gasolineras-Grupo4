...
public class MostrarListaDescuentosExitoUITest {
    ...
    public void mostrarListaDescuentosExitoso() {
        ...
        onView(withId(R.id.lvDiscounts)).check(matches(isDisplayed())).check(matches(hasChildCount(1)));
        ...
        descuento1.onChildView(withId(R.id.discountName)).check(matches(withText(d1.getDiscountName())));
        //descuento3.onChildView(withId(R.id.discountName)).check(matches(withText("Descuento3")));
        //descuento1.onChildView(withId(R.id.discountName)).check(matches(withText("Descuento1")));
